...
/// In case something is not found,
/// mostly used on api calls,
/// when the returned error is a status.code = 404.
const notfoundErrorMessage = 'Ops! Movie not found. Please, try another movie.';
